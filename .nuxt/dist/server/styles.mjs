...
export default {
  ...
  "components/HeroSection.vue": () => import('./_nuxt/HeroSection-styles.AONy96Ky.mjs').then(interopDefault),
  "components/HeroSection.vue?vue&type=style&index=0&scoped=4ecd66ca&lang.css": () => import('./_nuxt/HeroSection-styles.BMFYD2De.mjs').then(interopDefault),
